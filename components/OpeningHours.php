...
use EEV\Company\Classes\WorkingPeriodData;
use EEV\Company\Models\WorkingPeriod;
...
class OpeningHours extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'eev.company::lang.components.opening-hours.name',
            'description' => 'eev.company::lang.components.opening-hours.desc'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'short_days'      => [
                'title'             => 'eev.company::lang.short_days',
                'description'       => '',
                'default'           => false,
                'type'              => 'checkbox',
    ...
    public function getRows()
    {
        ...
        foreach ($this->convert() as $day => $item) :
            ...
            if ($item['around_the_clock']) {
                $result .= "<span class='opening-hours__time opening-hours__time_around'>" . trans("eev.company::lang.around_the_clock") . "</span>";
                $result .= "</li>";
                continue;
            }
...
//    }
    ...
    {
        $this->addCss('/plugins/eev/company/assets/css/opening-hours-component.min.css');
    }
